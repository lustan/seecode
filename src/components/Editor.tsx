...
export default function Editor({ value, onChange, isPopup = false, theme = 'dark', fontSize = 13, language, onLanguageChange, allNotes, activeNoteId, onSaveNote, showAlert }: Props) {
  return (
